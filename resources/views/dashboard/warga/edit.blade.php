...
<div class="container pb-5">
    <form action="/updatewarga/{{ $warga->id }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" value="{{$warga->name}}">
        </div>

        <div class="mb-3">
            <label for="alamat" class="mb-2 fw-bold">Alamat Warga</label>
            <input type="text" class="form-control" id="alamat" name="alamat" placeholder="1-5" value="{{$warga->alamat}}">
        </div>
